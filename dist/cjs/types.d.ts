 ...
 */
export type SlateElement = DocumentMetadata | QtiTextEntryInteraction | QtiInlineChoiceInteraction | QtiExtendedTextInteraction | QtiChoiceInteraction | QtiGapMatchInteraction | QtiMatchInteraction | QtiPrompt | QtiSimpleChoice | ChoiceIdLabel | ChoiceContent | GapMatchChoices | GapMatchContent | QtiGapText | QtiGapImg | QtiGap | MatchSourceSet | MatchTargetSet | QtiSimpleAssociableChoice | QtiFeedbackInline | QtiFeedbackBlock | QtiModalFeedback | QtiContentBody | UnknownQtiElement | ParagraphElement | DivElement | SpanElement | HeadingElement | ImageElement | LineBreakElement | ListElement | ListItemElement | StrongElement | EmElement | BlockquoteElement | HorizontalRuleElement;
/**
...
export interface ElementConfig {
     ...
     */
    generateCorrectnessCheck?: (responseId: string, responseDecl: XmlNode, doc: Document) => globalThis.Element;
    /**
     ...
     */
    generateFeedbackConditions?: (responseId: string, responseDecl: XmlNode, feedbackIds: Set<string>, doc: Document) => globalThis.Element[];
}
/**
