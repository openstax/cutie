...
exports.MatchInteractionHandler = void 0;
...
class MatchInteractionHandler {
    ...
    transform(element, context) {
        ...
        if (context.styleManager && !context.styleManager.hasStyle('cutie-match-interaction')) {
            context.styleManager.addStyle('cutie-match-interaction', styles_1.MATCH_INTERACTION_STYLES);
        }
        // Get required response-identifier
        const responseIdentifier = element.getAttribute('response-identifier');
        if (!responseIdentifier) {
            fragment.appendChild((0, errorDisplay_1.createMissingAttributeError)('qti-match-interaction', 'response-identifier'));
            return fragment;
        }
        ...
        const controller = new controller_1.MatchController(responseIdentifier, context, container, maxAssociations);
...
exports.MatchInteractionHandler = MatchInteractionHandler;
