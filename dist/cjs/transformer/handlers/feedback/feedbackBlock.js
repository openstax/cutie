...
class FeedbackBlockHandler {
    ...
    transform(element, context) {
        ...
        if (feedbackType && (0, feedbackIcons_1.isFeedbackType)(feedbackType)) {
            div.appendChild((0, feedbackIcons_1.createFeedbackIcon)(feedbackType));
        }
        if (context.transformChildren) {
            div.appendChild(context.transformChildren(element));
        }
        (0, feedbackAnnouncer_1.announceFeedback)(element, div, context);
        fragment.appendChild(div);
        return fragment;
    }
}
registry_1.registry.register('feedback-block', new FeedbackBlockHandler(), 50);
