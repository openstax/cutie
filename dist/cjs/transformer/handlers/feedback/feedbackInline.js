...
const feedbackAnnouncer_1 = require("./feedbackAnnouncer");
...
class FeedbackInlineHandler {
    ...
    transform(element, context) {
        ...
        if (feedbackType && (0, feedbackIcons_1.isFeedbackType)(feedbackType)) {
            span.appendChild((0, feedbackIcons_1.createFeedbackIcon)(feedbackType));
        }
        if (context.transformChildren) {
            span.appendChild(context.transformChildren(element));
        }
        (0, feedbackAnnouncer_1.announceFeedback)(element, span, context);
        fragment.appendChild(span);
        return fragment;
    }
}
registry_1.registry.register('feedback-inline', new FeedbackInlineHandler(), 50);
