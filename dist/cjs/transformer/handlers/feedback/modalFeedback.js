...
const feedbackIcons_1 = require("./feedbackIcons");
/**
...
class ModalFeedbackHandler {
    ...
    transform(element, context) {
        ...
        if (context.styleManager && !context.styleManager.hasStyle('cutie-feedback-icon')) {
            context.styleManager.addStyle('cutie-feedback-icon', feedbackIcons_1.FEEDBACK_ICON_STYLES);
        }
        const dialog = document.createElement('dialog');
        dialog.className = 'cutie-modal-feedback';
        (_a = context.onMount) === null || _a === void 0 ? void 0 : _a.call(context, () => {
            dialog.showModal();
        ...
        dialog.setAttribute('aria-label', (_b = feedbackLabels[feedbackType !== null && feedbackType !== void 0 ? feedbackType : '']) !== null && _b !== void 0 ? _b : 'Feedback');
        // Add icon header if feedback type is valid
        if (feedbackType && (0, feedbackIcons_1.isFeedbackType)(feedbackType)) {
            const header = document.createElement('div');
            header.className = 'cutie-modal-feedback__header';
            header.appendChild((0, feedbackIcons_1.createFeedbackIcon)(feedbackType));
...
`;
registry_1.registry.register('modal-feedback', new ModalFeedbackHandler(), 50);
