...
const vocabUtils_1 = require("../vocabUtils");
 ...
 */
class InlineChoiceInteractionHandler {
    canHandle(element) {
    ...
    transform(element, context) {
        ...
        if (context.styleManager &&
            !context.styleManager.hasStyle('cutie-inline-choice-interaction')) {
            context.styleManager.addStyle('cutie-inline-choice-interaction', INLINE_CHOICE_INTERACTION_STYLES);
        }
        // Extract required response-identifier attribute
        const responseIdentifier = element.getAttribute('response-identifier');
        if (!responseIdentifier) {
            console.error('qti-inline-choice-interaction missing required response-identifier attribute');
            fragment.appendChild((0, errorDisplay_1.createMissingAttributeError)('qti-inline-choice-interaction', 'response-identifier'));
            return fragment;
        }
        ...
        const inputWidth = (0, vocabUtils_1.parseInputWidth)(element);
        if (inputWidth !== null) {
            select.style.width = `${inputWidth + 4}ch`;
            select.style.minWidth = '0';
        }
        // Collect choices from qti-inline-choice children
        const choiceElements = Array.from(element.children).filter((child) => child.tagName.toLowerCase() === 'qti-inline-choice');
        // Add placeholder option for initial unselected state
        const placeholder = document.createElement('option');
        placeholder.value = '';
        placeholder.textContent = (_a = element.getAttribute('data-prompt')) !== null && _a !== void 0 ? _a : 'Select\u2026';
        ...
        for (const choiceElement of choiceElements) {
            ...
            option.textContent = (_b = choiceElement.textContent) !== null && _b !== void 0 ? _b : '';
        ...
        const minChoices = parseInt((_c = element.getAttribute('min-choices')) !== null && _c !== void 0 ? _c : '0', 10) || 0;
        ...
        if (isConstrained) {
            ...
            indicator = (0, validationDisplay_1.createInlineRequiredIndicator)(constraintId, customMessage !== null && customMessage !== void 0 ? customMessage : 'Selection required', context.styleManager);
        ...
        if (context.itemState) {
            const responseAccessor = () => {
                ...
                if (!isValid) {
                    ...
                    indicator === null || indicator === void 0 ? void 0 : indicator.setError(true);
                    return { value: null, valid: false };
                }
                select.removeAttribute('aria-invalid');
                indicator === null || indicator === void 0 ? void 0 : indicator.setError(false);
...
registry_1.registry.register('inline-choice-interaction', new InlineChoiceInteractionHandler(), 50);
