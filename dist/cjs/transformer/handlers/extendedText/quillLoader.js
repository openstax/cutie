...
exports.isQuillLoaded = isQuillLoaded;
exports.resetQuillLoader = resetQuillLoader;
...
async function loadQuill() {
    if (!quillPromise) {
        quillPromise = Promise.resolve().then(() => __importStar(require('quill')));
    }
    return quillPromise;
}
/**
