...
exports.createInteractionContainer = createInteractionContainer;
exports.processPrompt = processPrompt;
exports.parseConstraints = parseConstraints;
exports.getMinStringsText = getMinStringsText;
exports.getMinCharactersText = getMinCharactersText;
exports.getMaxCharactersText = getMaxCharactersText;
exports.getPatternText = getPatternText;
exports.createConstraintElements = createConstraintElements;
exports.wireConstraintDescribedBy = wireConstraintDescribedBy;
exports.parseMinCharacters = parseMinCharacters;
exports.parseMaxCharacters = parseMaxCharacters;
exports.parseExpectedLength = parseExpectedLength;
exports.parseCounterDirection = parseCounterDirection;
exports.createCharacterCounter = createCharacterCounter;
exports.createInteractionFooter = createInteractionFooter;
 ...
 */
function createInteractionContainer(element, className, responseIdentifier) {
 ...
 */
function processPrompt(element, responseIdentifier, context) {
 ...
 */
function parseConstraints(element) {
    var _a;
 ...
 */
function getMinStringsText(minStrings) {
    if (minStrings === 1)
 ...
 */
function createConstraintElements(constraints, responseIdentifier, styleManager) {
    var _a, _b;
    ...
    const constraint = (0, validationDisplay_1.createConstraintMessage)(`constraint-${responseIdentifier}`, initialText, styleManager);
 ...
 */
function wireConstraintDescribedBy(inputElement, constraintElement) {
 ...
 */
function parseMinCharacters(element) {
 ...
 */
function parseMaxCharacters(element) {
 ...
 */
function parseExpectedLength(element) {
 ...
 */
function parseCounterDirection(element) {
    var _a;
 ...
 */
function createCharacterCounter(targetLength, direction, responseIdentifier, styleManager, isHardLimit = false) {
 ...
 */
function createInteractionFooter(constraint, counter, styleManager) {
