...
const mathFieldLoader_1 = require("./mathFieldLoader");
const utils_1 = require("./utils");
/**
 * Check if a response declaration is a formula type
 */
function isFormulaResponse(doc, responseIdentifier) {
    if (!doc)
        return false;
    const responseDeclaration = doc.querySelector(`qti-response-declaration[identifier="${responseIdentifier}"]`);
 ...
 */
class FormulaInteractionHandler {
    canHandle(element) {
    ...
    transform(element, context) {
        ...
        const container = (0, utils_1.createInteractionContainer)(element, 'cutie-formula-interaction', responseIdentifier);
        ...
        const constraintResult = constraints.minStrings > 0
            ? (0, utils_1.createConstraintElements)(constraints, responseIdentifier, context.styleManager)
            : null;
        if (constraintResult) {
        ...
        const placeholderText = (_a = element.getAttribute('placeholder-text')) !== null && _a !== void 0 ? _a : '\\text{Enter a formula (e.g., }5x\\text{ or }\\frac{1}{2}\\text{)}';
        // Get default value
        ...
        if (context.itemState) {
            context.itemState.registerResponse(responseIdentifier, () => {
                ...
                if (!isValid) {
                    activeInputElement === null || activeInputElement === void 0 ? void 0 : activeInputElement.setAttribute('aria-invalid', 'true');
                ...
                activeInputElement === null || activeInputElement === void 0 ? void 0 : activeInputElement.removeAttribute('aria-invalid');
                constraintResult === null || constraintResult === void 0 ? void 0 : constraintResult.constraint.setError(false);
                return { value: trimmed === '' ? null : trimmed, valid: true };
            });
        }
        // Load MathLive asynchronously and create math-field
        (0, mathFieldLoader_1.loadMathLive)()
            .then((mathlive) => {
            ...
            if (constraintResult) {
                (0, utils_1.wireConstraintDescribedBy)(mathField, constraintResult.constraint.element);
            }
...
registry_1.registry.register('formula-interaction', new FormulaInteractionHandler(), 40);
