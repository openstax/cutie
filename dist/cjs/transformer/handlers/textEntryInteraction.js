 ...
 */
class TextEntryInteractionHandler {
    canHandle(element) {
    ...
    transform(element, context) {
        ...
        if (!responseIdentifier) {
            console.error('qti-text-entry-interaction missing required response-identifier attribute');
            fragment.appendChild((0, errorDisplay_1.createMissingAttributeError)('qti-text-entry-interaction', 'response-identifier'));
            return fragment;
        }
        // Find the response declaration to get base-type
        const responseDeclaration = (_a = element.ownerDocument) === null || _a === void 0 ? void 0 : _a.querySelector(`qti-response-declaration[identifier="${responseIdentifier}"]`);
        const baseType = responseDeclaration === null || responseDeclaration === void 0 ? void 0 : responseDeclaration.getAttribute('base-type');
        ...
        if (hasConstraint) {
            ...
            indicator = (0, validationDisplay_1.createInlineRequiredIndicator)(constraintId, patternMessage !== null && patternMessage !== void 0 ? patternMessage : 'Required format', context.styleManager);
...
registry_1.registry.register('text-entry-interaction', new TextEntryInteractionHandler(), 50);
