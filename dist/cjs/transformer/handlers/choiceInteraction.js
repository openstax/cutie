...
const rovingTabindex_1 = require("../../utils/rovingTabindex");
 ...
 */
function buildConstraintText(minChoices, maxChoices, isSingleSelect) {
    if (isSingleSelect) {
 ...
 */
class ChoiceInteractionHandler {
    canHandle(element) {
    ...
    transform(element, context) {
        ...
        if (!responseIdentifier) {
            fragment.appendChild((0, errorDisplay_1.createMissingAttributeError)('qti-choice-interaction', 'response-identifier'));
            return fragment;
        }
        const maxChoicesAttr = (_a = element.getAttribute('max-choices')) !== null && _a !== void 0 ? _a : '1';
        const maxChoices = parseInt(maxChoicesAttr, 10);
        if (isNaN(maxChoices)) {
            fragment.appendChild((0, errorDisplay_1.createInvalidAttributeError)('qti-choice-interaction', 'max-choices', maxChoicesAttr, 'Value must be a number'));
            return fragment;
        }
        ...
        const choiceElements = children.filter((child) => child.tagName.toLowerCase() === 'qti-simple-choice');
        ...
        if (orientation === 'horizontal' && !(sourceClasses === null || sourceClasses === void 0 ? void 0 : sourceClasses.includes('qti-orientation-'))) {
        ...
        const stackingMatch = sourceClasses === null || sourceClasses === void 0 ? void 0 : sourceClasses.match(/qti-choices-stacking-(\d)/);
        if (stackingMatch) {
            const cols = parseInt(stackingMatch[1], 10);
            if (cols > 1) {
                const isHorizontal = (sourceClasses === null || sourceClasses === void 0 ? void 0 : sourceClasses.includes('qti-orientation-horizontal')) ||
                    (!(sourceClasses === null || sourceClasses === void 0 ? void 0 : sourceClasses.includes('qti-orientation-')) && orientation === 'horizontal');
        ...
        if (hintText) {
            constraint = (0, validationDisplay_1.createConstraintMessage)(`constraint-${responseIdentifier}`, hintText, context.styleManager);
            ...
            choicesContainer.setAttribute('aria-describedby', existingDescribedBy
        ...
        if (isSingleSelect) {
            ...
            if (checkedRadio) {
                (0, rovingTabindex_1.updateRovingTabindex)(radioMap, checkedRadio);
            }
            else {
                (0, rovingTabindex_1.initializeRovingTabindex)(radioMap);
            }
            inputElements.forEach((input) => {
                input.addEventListener('change', () => {
                    if (input.checked)
                        (0, rovingTabindex_1.updateRovingTabindex)(radioMap, input);
                });
            });
        }
        ...
        if (context.itemState) {
            const getResponse = () => {
                ...
                if (isSingleSelect) {
                    return (_b = (_a = checked[0]) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : null;
                }
                else {
            ...
            const clearErrors = () => {
                ...
                if (hintText)
                    constraint === null || constraint === void 0 ? void 0 : constraint.setText(hintText);
            };
            const showErrors = () => {
                ...
                if (!isSingleSelect && maxChoices > 0 && checkedCount > maxChoices) {
                    const msg = maxSelectionsMessage !== null && maxSelectionsMessage !== void 0 ? maxSelectionsMessage : hintText;
                    if (msg)
                        constraint === null || constraint === void 0 ? void 0 : constraint.setText(msg);
                }
                else if (minChoices > 0 && checkedCount < minChoices) {
                    const msg = minSelectionsMessage !== null && minSelectionsMessage !== void 0 ? minSelectionsMessage : hintText;
                    if (msg)
                        constraint === null || constraint === void 0 ? void 0 : constraint.setText(msg);
                }
            };
                ...
                input.addEventListener('change', () => {
                    if (checkValidity()) {
                        ...
                        if (!isSingleSelect && maxChoices > 0 && checkedCount > maxChoices) {
                            ...
                            const msg = maxSelectionsMessage !== null && maxSelectionsMessage !== void 0 ? maxSelectionsMessage : hintText;
                            if (msg)
                                (0, liveRegion_1.announce)(context, msg, 'assertive');
                        }
                    }
                });
            });
...
registry_1.registry.register('choice-interaction', new ChoiceInteractionHandler(), 50);
/**
