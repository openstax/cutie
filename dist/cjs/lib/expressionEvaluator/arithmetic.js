...
exports.evaluateSubtract = evaluateSubtract;
exports.evaluateDivide = evaluateDivide;
exports.evaluateIntegerDivide = evaluateIntegerDivide;
exports.evaluateIntegerModulus = evaluateIntegerModulus;
exports.evaluateTruncate = evaluateTruncate;
exports.evaluateRound = evaluateRound;
exports.evaluatePower = evaluatePower;
const dom_1 = require("../../utils/dom");
/**
 * Evaluate qti-sum element
 */
function evaluateSum(element, itemDoc, variables, subEvaluate) {
    let sum = 0;
 ...
 */
function evaluateProduct(element, itemDoc, variables, subEvaluate) {
    let product = 1;
    for (const child of (0, dom_1.getChildElements)(element)) {
        const value = subEvaluate(child, itemDoc, variables);
        if (value !== null && value !== undefined) {
 ...
 */
function evaluateSubtract(element, itemDoc, variables, subEvaluate) {
 ...
 */
function evaluateDivide(element, itemDoc, variables, subEvaluate) {
    const children = Array.from((0, dom_1.getChildElements)(element));
    if (children.length !== 2) {
 ...
 */
function evaluateIntegerDivide(element, itemDoc, variables, subEvaluate) {
    const children = Array.from((0, dom_1.getChildElements)(element));
    if (children.length !== 2) {
 ...
 */
function evaluateIntegerModulus(element, itemDoc, variables, subEvaluate) {
    const children = Array.from((0, dom_1.getChildElements)(element));
    if (children.length !== 2) {
 ...
 */
function evaluateTruncate(element, itemDoc, variables, subEvaluate) {
    const children = Array.from((0, dom_1.getChildElements)(element));
 ...
 */
function evaluateRound(element, itemDoc, variables, subEvaluate) {
    const children = Array.from((0, dom_1.getChildElements)(element));
    if (children.length !== 1) {
 ...
 */
function evaluatePower(element, itemDoc, variables, subEvaluate) {
    const children = Array.from((0, dom_1.getChildElements)(element));
    if (children.length !== 2) {
