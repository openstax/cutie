...
exports.evaluateLessThan = evaluateLessThan;
exports.evaluateGreaterThan = evaluateGreaterThan;
exports.evaluateLessThanOrEqual = evaluateLessThanOrEqual;
exports.evaluateGreaterThanOrEqual = evaluateGreaterThanOrEqual;
exports.evaluateEqual = evaluateEqual;
 ...
 */
function evaluateLessThan(element, itemDoc, variables, subEvaluate) {
 ...
 */
function evaluateGreaterThan(element, itemDoc, variables, subEvaluate) {
    const children = Array.from((0, dom_1.getChildElements)(element));
    if (children.length !== 2) {
 ...
 */
function evaluateLessThanOrEqual(element, itemDoc, variables, subEvaluate) {
    const children = Array.from((0, dom_1.getChildElements)(element));
    if (children.length !== 2) {
 ...
 */
function evaluateGreaterThanOrEqual(element, itemDoc, variables, subEvaluate) {
    const children = Array.from((0, dom_1.getChildElements)(element));
    if (children.length !== 2) {
 ...
 */
function evaluateEqual(element, itemDoc, variables, subEvaluate) {
    const children = Array.from((0, dom_1.getChildElements)(element));
    if (children.length !== 2) {
    ...
    return (0, equality_1.deepEqual)(a, b);
}
/**
 ...
 */
function evaluateMatch(element, itemDoc, variables, subEvaluate) {
    var _a, _b, _c, _d;
    const values = [];
    const childElements = [];
    ...
    if (values.length >= 2) {
        ...
        if (isFirstMultiple || isSecondMultiple) {
            return (0, equality_1.deepEqualUnordered)(values[0], values[1]);
        }
        ...
        if (responseId) {
            ...
            if (formulaMode) {
                return (0, math_1.compareMathExpressions)(String((_c = values[0]) !== null && _c !== void 0 ? _c : ''), String((_d = values[1]) !== null && _d !== void 0 ? _d : ''), formulaMode);
            }
        ...
        return (0, equality_1.deepEqual)(values[0], values[1]);
    }
    return false;
}
