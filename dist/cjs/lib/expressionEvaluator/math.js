...
exports.compareMathExpressions = compareMathExpressions;
exports.getFormulaComparisonMode = getFormulaComparisonMode;
const compute_engine_1 = require("@cortex-js/compute-engine");
// Singleton compute engine instance
let computeEngine = null;
function getComputeEngine() {
    if (!computeEngine) {
        computeEngine = new compute_engine_1.ComputeEngine();
    }
 ...
 */
function compareMathExpressions(response, correct, mode = 'canonical') {
 ...
 */
function getFormulaComparisonMode(itemDoc, responseIdentifier) {
