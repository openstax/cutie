...
exports.compareResponseValues = compareResponseValues;
...
const math_1 = require("./expressionEvaluator/math");
const externalScoring_1 = require("./externalScoring");
 ...
 */
function compareResponseValues(itemDoc, responseIdentifier, responseValue, correctValue) {
    ...
    if ((meta === null || meta === void 0 ? void 0 : meta.responseType) === 'formula') {
        ...
        return (0, math_1.compareMathExpressions)(String(responseValue !== null && responseValue !== void 0 ? responseValue : ''), String(correctValue !== null && correctValue !== void 0 ? correctValue : ''), mode);
    }
    ...
    if (cardinality === 'multiple') {
        return (0, equality_1.deepEqualUnordered)(responseValue, correctValue);
    }
    return (0, equality_1.deepEqual)(responseValue, correctValue);
}
/**
 ...
 */
function processResponse(itemDoc, submission, currentState) {
    ...
    if (responseProcessing) {
        ...
        if (template) {
            ...
            for (const child of (0, dom_1.getChildElements)(responseProcessing)) {
    ...
    const completionStatus = variables.completionStatus === 'incomplete'
        ? 'incomplete'
        : 'completed';
    const externalInfo = (0, externalScoring_1.getExternalScoredInfo)(itemDoc, variables);
    return {
        variables,
        completionStatus,
        score,
            ...
            if (correctResponse) {
                ...
                if (cardinality === 'single') {
                    if (valueElements.length > 0) {
                        return (0, typeParser_1.parseResponseValue)(valueElements[0].textContent || '', baseType);
                    }
                }
                else if (cardinality === 'multiple' || cardinality === 'ordered') {
                    const values = [];
                    for (let j = 0; j < valueElements.length; j++) {
                        values.push((0, typeParser_1.parseResponseValue)(valueElements[j].textContent || '', baseType));
                    }
                    return values;
                }
            }
