...
exports.getMappingElement = getMappingElement;
exports.getMapping = getMapping;
exports.removeMapping = removeMapping;
exports.addEmptyMapping = addEmptyMapping;
exports.updateMappingMetadata = updateMappingMetadata;
exports.setMapEntries = setMapEntries;
exports.getMaxMappedValue = getMaxMappedValue;
 ...
 */
function hasMapping(decl) {
    return !!(0, xmlNode_1.findChild)(decl, 'qti-mapping');
}
/**
 * Get the mapping element from a declaration
 */
function getMappingElement(decl) {
    return (0, xmlNode_1.findChild)(decl, 'qti-mapping');
}
/**
 * Extract mapping data from a declaration
 */
function getMapping(decl) {
    const mapping = (0, xmlNode_1.findChild)(decl, 'qti-mapping');
    if (!mapping)
        return undefined;
    ...
    const entries = (0, xmlNode_1.findChildren)(mapping, 'qti-map-entry').map(entry => {
 ...
 */
function addEmptyMapping(decl, defaultValue = 0) {
 ...
 */
function updateMappingMetadata(decl, metadata) {
    const mapping = (0, xmlNode_1.findChild)(decl, 'qti-mapping');
    if (!mapping)
        return decl;
    const newAttributes = {
 ...
 */
function setMapEntries(decl, entries) {
    const mapping = (0, xmlNode_1.findChild)(decl, 'qti-mapping');
    if (!mapping)
        return decl;
 ...
 */
function getMaxMappedValue(decl) {
 ...
 */
function updateMapping(decl, metadata, entries) {
