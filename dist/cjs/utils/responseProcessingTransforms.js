...
exports.updateResponseProcessingMode = updateResponseProcessingMode;
exports.getResponseProcessingConfig = getResponseProcessingConfig;
 ...
 */
function updateResponseProcessingMode(editor, mode) {
    // Find the metadata node at [0]
    const [entry] = slate_1.Editor.nodes(editor, {
        at: [0],
 ...
 */
function getResponseProcessingConfig(editor) {
    const [entry] = slate_1.Editor.nodes(editor, {
        at: [0],
        match: (n) => 'type' in n && n.type === 'document-metadata',
    });
