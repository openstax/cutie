...
exports.LIVE_REGION_STYLES = void 0;
...
function getOrCreateLiveRegion(ctx, urgency) {
    ...
    if (!state.element) {
        ...
        state.element.style.cssText = exports.LIVE_REGION_STYLES;
 ...
 */
function announce(ctx, message, urgency = 'polite') {
    const state = regions[urgency];
