...
exports.insertFeedbackBlock = insertFeedbackBlock;
exports.isInFeedbackBlock = isInFeedbackBlock;
 ...
 */
function insertFeedbackBlock(editor, identifier, showHide = 'show') {
    const feedbackNode = {
 ...
 */
function isInFeedbackBlock(editor) {
