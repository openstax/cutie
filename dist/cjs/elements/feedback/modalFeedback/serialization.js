...
exports.modalFeedbackSerializers = exports.modalFeedbackParsers = void 0;
...
function serializeModalFeedback(element, context, convertChildren) {
    const xmlElement = (0, xmlUtils_1.createXmlElement)(context.doc, 'qti-modal-feedback');
    // Set attributes
 ...
 */
exports.modalFeedbackParsers = {
    'qti-modal-feedback': parseModalFeedback,
};
exports.modalFeedbackSerializers = {
