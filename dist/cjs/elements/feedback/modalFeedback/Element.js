...
exports.ModalFeedbackElement = ModalFeedbackElement;
 ...
 */
function ModalFeedbackElement({ attributes, children, element, }) {
    const el = element;
    ...
    (0, useStyle_1.useStyle)('modal-feedback', MODAL_FEEDBACK_STYLES);
    ...
    return ((0, jsx_runtime_1.jsxs)("fieldset", { ...attributes, className: containerClass, children: [(0, jsx_runtime_1.jsxs)("legend", { contentEditable: false, className: "modal-feedback__legend", children: [!isValid && (0, jsx_runtime_1.jsx)("span", { title: "Invalid feedback identifier", children: "\u26A0 " }), "Modal Feedback: ", showHide === 'hide' ? 'Hide' : 'Show', " when ", displayLabel] }), (0, jsx_runtime_1.jsx)("div", { children: children })] }));
}
