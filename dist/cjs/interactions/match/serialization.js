...
exports.matchSerializers = exports.matchParsers = void 0;
...
function serializeMatchInteraction(element, context, convertChildren) {
    const xmlElement = (0, xmlUtils_1.createXmlElement)(context.doc, 'qti-match-interaction');
    ...
    if (responseId) {
        ...
        context.responseConfigs.set(responseId, config_1.matchInteractionConfig);
    }
    else {
        context.errors.push({
    ...
    for (const child of element.children) {
        if ('type' in child) {
            if (child.type === 'qti-prompt') {
                ...
                const promptEl = (0, xmlUtils_1.createXmlElement)(context.doc, 'qti-prompt');
                ...
                const matchSet = (0, xmlUtils_1.createXmlElement)(context.doc, 'qti-simple-match-set');
...
function serializeSimpleAssociableChoice(element, context, convertChildren) {
    const xmlElement = (0, xmlUtils_1.createXmlElement)(context.doc, 'qti-simple-associable-choice');
    // Set attributes
    for (const [key, value] of Object.entries(element.attributes)) {
        if (value !== undefined) {
            xmlElement.setAttribute(key, value);
 ...
 */
exports.matchParsers = {
    'qti-match-interaction': parseMatchInteraction,
};
exports.matchSerializers = {
