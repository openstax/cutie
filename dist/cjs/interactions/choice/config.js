...
exports.choiceInteractionConfig = void 0;
...
exports.choiceInteractionConfig = {
    ...
    matches: (element) => 'type' in element && element.type === 'qti-choice-interaction',
    ...
    generateFeedbackConditions: (responseId, responseDecl, feedbackIds, doc) => {
        var _a;
        const conditions = [];
        const cardinality = ((_a = responseDecl.attributes) === null || _a === void 0 ? void 0 : _a.cardinality) || 'single';
        ...
        for (const feedbackId of feedbackIds) {
            ...
            if ((parsed === null || parsed === void 0 ? void 0 : parsed.type) === 'choice' && parsed.choiceId) {
                ...
                responseIf.appendChild((0, responseProcessingGenerator_1.createSetFeedbackElement)(feedbackId, doc));
                condition.appendChild(responseIf);
                conditions.push(condition);
            }
        }
