 ...
 */
export function generateResponseProcessingXml(config, responseIdentifiers, responseDeclarations, outcomeDeclarations, doc, feedbackIdentifiersUsed, responseConfigs) {
...
function createCorrectnessCheckForId(id, responseDeclarations, responseConfigs, doc) {
    ...
    if (decl && hasMapping(decl)) {
        const maxValue = getMaxMappedValue(decl);
        if (maxValue !== null) {
 ...
 */
export function createMatchElement(identifier, doc) {
 ...
 * </qti-equal>
 */
export function createMapResponseEqualElement(identifier, value, doc) {
 ...
 */
export function createMapResponseGtZeroElement(identifier, doc) {
 ...
 * </qti-set-outcome-value>
 */
export function createSetFeedbackElement(feedbackId, doc) {
