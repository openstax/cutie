 ...
 */
export function getFeedbackIdentifiersForInteraction(element) {
    return getElementFeedbackIdentifiers(element);
}
/**
 * Recursively collect all feedback identifiers from all interactions in a document
 */
export function collectFeedbackIdentifiers(nodes) {
    const sources = [];
 ...
 */
export function getAllFeedbackIdentifierIds(nodes) {
 ...
 */
export function getAllFeedbackIdentifierOptions(nodes) {
    const sources = collectFeedbackIdentifiers(nodes);
    const options = [];
    for (const source of sources) {
        for (const identifier of source.identifiers) {
 ...
 */
export function parseFeedbackIdentifier(identifier) {
 ...
 */
export function isStandardFeedbackIdentifier(identifier) {
