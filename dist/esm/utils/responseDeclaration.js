 ...
 */
export function addEmptyCorrectResponse(decl) {
 ...
 */
export function getCorrectValues(decl) {
 ...
 */
export function getCorrectValue(decl) {
    const correctResponse = findChild(decl, 'qti-correct-response');
    if (!correctResponse)
        return '';
 ...
 */
export function setCorrectValues(decl, values, cardinality) {
 ...
 */
export function updateCorrectValue(decl, value) {
 ...
 */
export function updateDeclAttribute(decl, key, value) {
    return {
        tagName: decl.tagName,
 ...
 */
export function getIdentifier(decl) {
    return decl.attributes['identifier'] || '';
}
/**
 * Get an arbitrary attribute from a response declaration
 */
export function getResponseDeclAttribute(decl, attrName) {
    var _a;
 ...
 */
export function removeDeclAttribute(decl, attrName) {
