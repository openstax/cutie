 ...
 */
export declare function highlightDropTargets(elements: Iterable<HTMLElement>, highlightClass: string, isValid?: (el: HTMLElement) => boolean): void;
/**
 ...
 */
export declare function clearDropTargetHighlights(elements: Iterable<HTMLElement>, highlightClass: string): void;
