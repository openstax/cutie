 ...
 */
export function createErrorElement(title, message) {
 ...
 */
export function createUnsupportedElement(elementName) {
 ...
 * @returns HTMLElement configured with error styling
 */
export function createMissingAttributeError(elementName, attributeName) {
 ...
 * @returns HTMLElement configured with error styling
 */
export function createInvalidAttributeError(elementName, attributeName, value, reason) {
