 ...
 */
export function evaluateMultiple(element, itemDoc, variables, subEvaluate) {
    const values = [];
 ...
 */
export function evaluateOrdered(element, itemDoc, variables, subEvaluate) {
    return evaluateMultiple(element, itemDoc, variables, subEvaluate);
}
/**
 * Evaluate qti-container-size element
 */
export function evaluateContainerSize(element, itemDoc, variables, subEvaluate) {
    for (const child of getChildElements(element)) {
 ...
 */
export function evaluateRepeat(element, itemDoc, variables, subEvaluate) {
 ...
 */
export function evaluateDelete(element, itemDoc, variables, subEvaluate) {
    const values = [];
    for (const child of getChildElements(element)) {
 ...
 */
export function evaluateMember(element, itemDoc, variables, subEvaluate) {
    const children = Array.from(getChildElements(element));
 ...
 */
export function evaluateContains(element, itemDoc, variables, subEvaluate) {
    const children = Array.from(getChildElements(element));
    if (children.length !== 2) {
 ...
 */
export function evaluateIndex(element, itemDoc, variables, subEvaluate) {
