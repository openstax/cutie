 ...
 */
export function evaluateSum(element, itemDoc, variables, subEvaluate) {
    let sum = 0;
 ...
 */
export function evaluateProduct(element, itemDoc, variables, subEvaluate) {
    let product = 1;
    for (const child of getChildElements(element)) {
        const value = subEvaluate(child, itemDoc, variables);
        if (value !== null && value !== undefined) {
 ...
 */
export function evaluateSubtract(element, itemDoc, variables, subEvaluate) {
 ...
 */
export function evaluateDivide(element, itemDoc, variables, subEvaluate) {
    const children = Array.from(getChildElements(element));
    if (children.length !== 2) {
 ...
 */
export function evaluateIntegerDivide(element, itemDoc, variables, subEvaluate) {
    const children = Array.from(getChildElements(element));
    if (children.length !== 2) {
 ...
 */
export function evaluateIntegerModulus(element, itemDoc, variables, subEvaluate) {
    const children = Array.from(getChildElements(element));
    if (children.length !== 2) {
 ...
 */
export function evaluateTruncate(element, itemDoc, variables, subEvaluate) {
    const children = Array.from(getChildElements(element));
 ...
 */
export function evaluateRound(element, itemDoc, variables, subEvaluate) {
    const children = Array.from(getChildElements(element));
    if (children.length !== 1) {
 ...
 */
export function evaluatePower(element, itemDoc, variables, subEvaluate) {
    const children = Array.from(getChildElements(element));
    if (children.length !== 2) {
