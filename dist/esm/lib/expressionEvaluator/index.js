...
import { evaluateDivide, evaluateIntegerDivide, evaluateIntegerModulus, evaluatePower, evaluateProduct, evaluateRound, evaluateSubtract, evaluateSum, evaluateTruncate, } from './arithmetic';
import { evaluateBaseValue, evaluateVariable } from './base';
import { evaluateEqual, evaluateGreaterThan, evaluateGreaterThanOrEqual, evaluateLessThan, evaluateLessThanOrEqual, evaluateMatch, } from './comparison';
import { evaluateContainerSize, evaluateContains, evaluateDelete, evaluateIndex, evaluateMember, evaluateMultiple, evaluateOrdered, evaluateRepeat, } from './containers';
...
import { evaluateAnyN, evaluateIntegerToFloat, evaluateIsNull, evaluateRandom, evaluateRandomFloat, evaluateRandomInteger, } from './utility';
/**
 ...
 */
export function evaluateExpression(element, itemDoc, variables, subEvaluate) {
