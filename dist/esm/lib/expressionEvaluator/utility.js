 ...
 */
export function evaluateIntegerToFloat(element, itemDoc, variables, subEvaluate) {
 ...
 */
export function evaluateAnyN(element, itemDoc, variables, subEvaluate) {
 ...
 */
export function evaluateIsNull(element, itemDoc, variables, subEvaluate) {
    for (const child of getChildElements(element)) {
        const value = subEvaluate(child, itemDoc, variables);
 ...
 */
export function evaluateRandom(element, itemDoc, variables, subEvaluate) {
    for (const child of getChildElements(element)) {
        const container = subEvaluate(child, itemDoc, variables);
        if (!Array.isArray(container)) {
 ...
 */
export function evaluateRandomInteger(element) {
 ...
 */
export function evaluateRandomFloat(element) {
