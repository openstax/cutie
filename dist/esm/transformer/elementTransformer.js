 ...
 */
export function createTransformContext(baseContext = {}) {
    var _a;
    const styleManager = (_a = baseContext.styleManager) !== null && _a !== void 0 ? _a : new DefaultStyleManager();
    const context = {
        ...baseContext,
        styleManager,
 ...
 */
export function transformNode(element, context) {
 ...
 */
export function transformChildren(element, context) {
    const fragment = document.createDocumentFragment();
 ...
 */
export function transformElement(element, baseContext = {}) {
 ...
 */
export function getStyleManager(context) {
    var _a;
    return (_a = context.styleManager) !== null && _a !== void 0 ? _a : new DefaultStyleManager();
}
