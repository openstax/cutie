...
import { createCharacterCounter, createConstraintElements, createInteractionContainer, createInteractionFooter, parseConstraints, parseCounterDirection, parseExpectedLength, processPrompt, wireConstraintDescribedBy, } from './utils';
...
class RichTextInteractionHandler {
    ...
    transform(element, context) {
        ...
        if (!responseIdentifier) {
            ...
            fragment.appendChild(createMissingAttributeError('qti-extended-text-interaction', 'response-identifier'));
            return fragment;
        }
        ...
        if (counterTarget !== null && effectiveDirection !== null) {
            counter = createCharacterCounter(counterTarget, effectiveDirection, responseIdentifier, context.styleManager, isHardLimit);
        }
        ...
        const constraintResult = needsConstraint
            ? createConstraintElements({ minStrings: constraints.minStrings, patternMask: null, patternMessage: null, minCharacters, maxCharacters }, responseIdentifier, context.styleManager)
            : null;
        // Wrap counter and/or constraint in a shared footer row
        const footer = createInteractionFooter((_a = constraintResult === null || constraintResult === void 0 ? void 0 : constraintResult.constraint.element) !== null && _a !== void 0 ? _a : null, (_b = counter === null || counter === void 0 ? void 0 : counter.element) !== null && _b !== void 0 ? _b : null, context.styleManager);
        if (footer) {
