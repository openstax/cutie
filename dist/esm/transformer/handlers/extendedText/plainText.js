...
class ExtendedTextInteractionHandler {
    ...
    transform(element, context) {
        ...
        if (counterTarget !== null && effectiveDirection !== null) {
            const counter = createCharacterCounter(counterTarget, effectiveDirection, responseIdentifier, context.styleManager, isHardLimit);
        ...
        const footer = createInteractionFooter((_a = constraintResult === null || constraintResult === void 0 ? void 0 : constraintResult.constraint.element) !== null && _a !== void 0 ? _a : null, counterElement, context.styleManager);
        if (footer) {
