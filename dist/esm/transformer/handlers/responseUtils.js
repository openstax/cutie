 ...
 */
export function getDefaultValue(doc, responseIdentifier) {
    var _a;
    if (!doc)
        return null;
    ...
    if (valueElements.length === 0)
        return null;
    const values = Array.from(valueElements).map((el) => { var _a; return (_a = el.textContent) !== null && _a !== void 0 ? _a : ''; });
    ...
    return (_a = values[0]) !== null && _a !== void 0 ? _a : null;
}
