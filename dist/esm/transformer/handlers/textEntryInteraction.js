...
class TextEntryInteractionHandler {
    ...
    transform(element, context) {
        ...
        if (!responseIdentifier) {
            ...
            fragment.appendChild(createMissingAttributeError('qti-text-entry-interaction', 'response-identifier'));
            return fragment;
        }
        ...
        if (hasConstraint) {
            ...
            indicator = createInlineRequiredIndicator(constraintId, patternMessage !== null && patternMessage !== void 0 ? patternMessage : 'Required format', context.styleManager);
