import { createInvalidAttributeError, createMissingAttributeError, } from '../../errors/errorDisplay';
...
class ChoiceInteractionHandler {
    ...
    transform(element, context) {
        ...
        if (hintText) {
            constraint = createConstraintMessage(`constraint-${responseIdentifier}`, hintText, context.styleManager);
        ...
        if (isSingleSelect) {
            ...
            inputElements.forEach((input) => {
                input.addEventListener('change', () => {
                    if (input.checked)
                        updateRovingTabindex(radioMap, input);
                });
            });
        }
