import { announce, clearDropTargetHighlights, focusNext, focusPrev, highlightDropTargets, } from '../../../utils';
/**
...
export class GapMatchController {
    ...
    wireChoiceEvents(choiceId, element) {
        ...
        element.addEventListener('dragstart', (e) => {
            ...
            highlightDropTargets(this.gapElements.values(), 'cutie-gap--drop-target', (el) => {
