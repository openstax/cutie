import { announce, clearDropTargetHighlights, focusNext, focusPrev, highlightDropTargets, updateRovingTabindex, } from '../../../utils';
/**
...
export class MatchController {
    ...
    select(originId, existingAssociation, chipElement) {
        ...
        const connectedId = existingAssociation
            ...
            : null;
        highlightDropTargets(this.getChoiceElementsArray(oppositeSet), 'cutie-match-choice--drop-target', (el) => {
        ...
        if (existingAssociation) {
            announce(this.context, `${choice.content} selected. Click again or press backspace to remove. Click another item to move.`);
        }
        else {
    ...
    clearSelection() {
        ...
        clearDropTargetHighlights(this.getAllChoiceElements(), 'cutie-match-choice--drop-target');
    }
    /**
