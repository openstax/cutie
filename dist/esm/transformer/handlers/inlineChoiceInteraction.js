...
import { createInlineRequiredIndicator, } from '../../errors/validationDisplay';
...
class InlineChoiceInteractionHandler {
    ...
    transform(element, context) {
        ...
        if (!responseIdentifier) {
            ...
            fragment.appendChild(createMissingAttributeError('qti-inline-choice-interaction', 'response-identifier'));
            return fragment;
        }
        ...
        if (isConstrained) {
            ...
            indicator = createInlineRequiredIndicator(constraintId, customMessage !== null && customMessage !== void 0 ? customMessage : 'Selection required', context.styleManager);
...
registry.register('inline-choice-interaction', new InlineChoiceInteractionHandler(), 50);
