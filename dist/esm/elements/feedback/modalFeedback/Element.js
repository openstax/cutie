 ...
 */
export function ModalFeedbackElement({ attributes, children, element, }) {
    const el = element;
    ...
    return (_jsxs("fieldset", { ...attributes, className: containerClass, children: [_jsxs("legend", { contentEditable: false, className: "modal-feedback__legend", children: [!isValid && _jsx("span", { title: "Invalid feedback identifier", children: "\u26A0 " }), "Modal Feedback: ", showHide === 'hide' ? 'Hide' : 'Show', " when ", displayLabel] }), _jsx("div", { children: children })] }));
}
