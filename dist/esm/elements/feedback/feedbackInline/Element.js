 ...
 */
export function FeedbackInlineElement({ attributes, children, element, }) {
    const el = element;
    ...
    return (_jsxs("span", { ...attributes, className: containerClass, children: [_jsxs("span", { contentEditable: false, className: "feedback-inline__label", children: [!isValid && _jsx("span", { title: "Invalid feedback identifier", children: "\u26A0 " }), showHide === 'hide' ? 'Hide' : 'Show', " when ", displayLabel] }), children] }));
}
