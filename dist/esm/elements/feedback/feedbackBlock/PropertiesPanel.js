 ...
 */
export function FeedbackBlockPropertiesPanel({ element, path, onUpdate, responseProcessingConfig, }) {
    ...
    return (_jsxs("div", { className: "property-editor", children: [_jsx("h3", { children: "Feedback (Block)" }), isCustomMode && _jsx(CustomModeWarning, {}), _jsx(IdentifierSelector, { value: currentIdentifier, options: feedbackOptions, onChange: handleIdentifierChange, disabled: isCustomMode }), _jsx(ShowHideRadioGroup, { value: currentShowHide, onChange: handleShowHideChange, name: "show-hide-block", disabled: isCustomMode }), _jsx(FeedbackTypeSelector, { value: currentFeedbackType, onChange: handleFeedbackTypeChange }), currentIdentifier && !isCustomMode && (_jsx(IdentifierTip, { identifier: currentIdentifier, options: feedbackOptions })), isCustomMode && (_jsx(ReadonlyAttributeInfo, { outcomeIdentifier: attrs['outcome-identifier'] || 'FEEDBACK', identifier: currentIdentifier, showHide: currentShowHide }))] }));
}
