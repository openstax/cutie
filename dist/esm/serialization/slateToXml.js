...
import { xmlNodeToDom } from './xmlNode';
 ...
 */
export function serializeSlateToXml(nodes) {
...
const interactionSerializers = {
    ...
    ...modalFeedbackSerializers,
    ...contentBodySerializers,
};
/**
...
function updateResponseProcessing(assessmentItem, config, responseIdentifiers, responseDeclarations, outcomeDeclarations, feedbackIdentifiersUsed, responseConfigs, doc) {
    ...
    if (config) {
        const newRP = generateResponseProcessingXml(config, responseIdentifiers, responseDeclarations, outcomeDeclarations, doc, feedbackIdentifiersUsed, responseConfigs);
        if (newRP) {
 ...
 */
export function serializeSlateToQti(nodes, originalQtiXml) {
    var _a;
