 ...
 */
export function createXmlElement(doc, tagName) {
 ...
 */
export function isQtiElement(tagName) {
 ...
 */
export function extractItemBodyXml(qtiXml) {
 ...
 */
export function htmlToXhtml(html) {
    // Parse as HTML
