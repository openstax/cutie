 ...
 */
export function generateGapId(editor, interactionPath) {
 ...
 */
export function generateChoiceId(editor, interactionPath) {
    const existingIds = new Set();
 ...
 */
export function insertGapMatchInteraction(editor, config = {}) {
    ...
    Transforms.insertNodes(editor, gapMatchInteraction, { at: insertPoint });
    ...
    Transforms.insertNodes(editor, { type: 'paragraph', children: [{ text: '' }] }, { at: interactionEntry ? [interactionEntry[1][0] + 1] : undefined });
}
/**
 ...
 */
export function insertGapOrChoiceAtSelection(editor) {
    const { selection } = editor;
    if (!selection)
        return false;
    ...
    if (hasTextSelection(editor)) {
        ...
        if (interaction) {
            ...
            if (responseDecl) {
                ...
                Transforms.setNodes(editor, { responseDeclaration: updatedDecl }, { at: interactionPath });
            }
        }
        return 'choice';
    }
 ...
 */
export function insertGapAtSelection(editor) {
