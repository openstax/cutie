...
import { inlineChoiceInteractionConfig } from './config';
/**
...
function serializeInlineChoiceInteraction(element, context, _convertChildren) {
    ...
    if (responseId) {
        ...
        context.responseConfigs.set(responseId, inlineChoiceInteractionConfig);
    }
    else {
        context.errors.push({
 ...
 */
export const inlineChoiceParsers = {
    'qti-inline-choice-interaction': parseInlineChoiceInteraction,
};
export const inlineChoiceSerializers = {
