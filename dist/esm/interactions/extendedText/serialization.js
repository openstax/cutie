...
import { extendedTextInteractionConfig } from './config';
/**
...
function serializeExtendedTextInteraction(element, context, convertChildren) {
    ...
    if (responseId) {
        ...
        context.responseConfigs.set(responseId, extendedTextInteractionConfig);
    }
    else {
        context.errors.push({
 ...
 */
export const extendedTextParsers = {
    'qti-extended-text-interaction': parseExtendedTextInteraction,
};
export const extendedTextSerializers = {
