 ...
 */
export function generateSourceId(editor, interactionPath) {
 ...
 */
export function generateTargetId(editor, interactionPath) {
    const existingIds = new Set();
 ...
 */
export function insertMatchInteraction(editor, config = {}) {
    var _a;
    ...
    Transforms.insertNodes(editor, matchInteraction, { at: insertPoint });
