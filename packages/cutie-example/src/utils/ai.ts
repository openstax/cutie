...
const quizResponse = z.object({
  topic: z.string().describe(`An atomic topic related to these questions. It should be specific and focused. The topic MUST be related to the specified area of interest. The topic MUST NOT be the same as the specified area of interest, it should be something smaller and more focused.`),
