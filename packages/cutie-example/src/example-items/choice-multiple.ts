// Source: https://github.com/1EdTech/qti-examples/blob/master/qtiv3-examples/packaging/items/choice_multiple.xml

export const name = "Multiple Choice - Composition of Water";
