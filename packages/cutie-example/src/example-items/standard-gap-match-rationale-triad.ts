...
adaptive="false" time-dependent="false" xml:lang="en">
  ...
  <qti-item-body>
    <p>A weather station records a sudden change in conditions. Drag each word into its
      matching blank below.</p>

    <qti-gap-match-interaction response-identifier="RESPONSE" shuffle="false" min-associations="3" max-associations="3">
      <qti-prompt>Drag the event and the two readings into their blanks.</qti-prompt>
