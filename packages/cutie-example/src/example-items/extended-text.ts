// Source: https://github.com/1EdTech/qti-examples/blob/master/qtiv3-examples/packaging/items/extended_text.xml

export const name = "Extended Text - Writing a Postcard";
...
<qti-assessment-item xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                     ...
                     identifier="extendedText" title="Writing a Postcard" adaptive="false" time-dependent="false">
