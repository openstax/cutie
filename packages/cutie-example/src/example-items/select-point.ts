// Source: https://github.com/1EdTech/qti-examples/blob/master/qtiv3-examples/packaging/items/select_point.xml

export const name = "Select Point - Where is Edinburgh?";
...
<qti-assessment-item xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                     ...
                     identifier="selectPoint" title="Where is Edinburgh?" adaptive="false" time-dependent="false">
	<qti-response-declaration identifier="RESPONSE" cardinality="single" base-type="point">
		<qti-correct-response>
			<qti-value>102 113</qti-value>
		</qti-correct-response>
		<qti-area-mapping default-value="0">
			<qti-area-map-entry shape="circle" coords="102,113,16" mapped-value="1"/>
		</qti-area-mapping>
	...
	<qti-response-processing template="https://www.imsglobal.org/question/qti_v3p0/rptemplates/map_response_point.xml"/>
</qti-assessment-item>`;

export const interactionTypes: string[] = ['select-point'];
