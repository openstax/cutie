// Source: https://github.com/1EdTech/qti-examples/blob/master/qtiv3-examples/packaging/items/gap_match.xml

export const name = "Gap Match - Richard III Quote";
...
<qti-assessment-item xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	...
	<qti-item-body>
		<qti-gap-match-interaction response-identifier="RESPONSE" shuffle="false">
			...
			<blockquote>
				<p>Now is the <qti-gap identifier="G1"/> of our discontent<br/> Made glorious <qti-gap identifier="G2"/> by this sun of York;<br/> And all the clouds that lour'd
