// Source: https://github.com/1EdTech/qti-examples/blob/master/qtiv3-examples/packaging/items/inline_choice.xml

export const name = "Inline Choice - Richard III Quote";

export const item = `<?xml version="1.0" encoding="UTF-8"?>
<qti-assessment-item xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation=" http://www.imsglobal.org/xsd/imsqtiasi_v3p0 https://purl.imsglobal.org/spec/qti/v3p0/schema/xsd/imsqti_asiv3p0_v1p0.xsd " identifier="inlineChoice" title="Richard III (Take 2)" adaptive="false" time-dependent="false">
	...
	<qti-item-body>
		...
		<blockquote>
			<p>Now is the winter of our discontent<br/> Made glorious summer by this sun of
				...
				</qti-inline-choice-interaction>;<br/> And all the clouds that lour'd upon our house<br/>
